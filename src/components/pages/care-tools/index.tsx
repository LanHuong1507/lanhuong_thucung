              ...
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-90 transition-opacity duration-300 flex flex-col justify-center items-center p-4">
                ...
                >
                  <Button
                    type="primary"
                    block
                    className="w-full text-center py-4 px-6 text-lg rounded-lg text-white font-semibold bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 transition duration-300 mb-4"
                  >
                    Xem chi tiết
                  </Button>
                </Link>
                ...
                <Link href={routerNames.CONTACT}>
                  <Button
                    type="default"
                    block
                    className="w-full text-center py-4 px-6 text-lg rounded-lg text-white font-semibold bg-green-600 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-600 transition duration-300"
                  >
                    Liên hệ ngay
                  </Button>
                </Link>
