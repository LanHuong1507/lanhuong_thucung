...
const RabbitDetail = () => {
  ...
  useEffect(() => {
    if (id && rabbits.length > 0) {
      const foundRabbit = rabbits.find((item) => item.id === Number(id));
  ...
  useEffect(() => {
    if (rabbit) {
      const slideshowImages = [
        rabbit.image,
        ...(Array.isArray(rabbit.thumnail) ? rabbit.thumnail : []),
      ];
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-4 border-dotted border-gray-400 p-4 rounded-lg shadow-lg bg-gray-50">
          <div className="col-span-1 border-2 border-solid border-gray-300 rounded-lg p-2">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              {[rabbit.image, ...rabbit.thumnail].map((thumb, index) => (
                <div
                  key={index}
          ...
          <div className="col-span-2 border-2 border-solid border-gray-300 rounded-lg p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  <strong>Xuất xứ:</strong> {rabbit.origin}
                </p>
                <p>
                  <strong>Kích thước:</strong> {rabbit.size}
                </p>
                <p>
                  <strong>Tuổi thọ:</strong> {rabbit.life_span}
                </p>
                <p>
                  <strong>Bộ lông:</strong> {rabbit.coat}
                </p>
                <p>
                  <strong>Giá:</strong> {rabbit.price}
                </p>
              </div>
              ...
              <div>
                ...
                <p>{rabbit.additional_info.care_tips}</p>
              </div>
              ...
              <div>
                ...
                <p>{rabbit.additional_info.health_issues}</p>
              </div>
              ...
              <div>
                ...
                <p>{rabbit.additional_info.exercise_needs}</p>
              </div>
              ...
              <div>
                ...
                <p>{rabbit.additional_info.diet}</p>
              </div>
            </div>
