    ...
    <div className="relative">
      <Slider {...settings}>
        <div className="relative w-full h-screen bg-gradient-to-r from-blue-100 to-blue-200 flex flex-col items-center justify-center py-20">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold leading-snug text-gray-800 mb-6">
        ...
        <div className="relative w-full h-screen">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center text-gray-800 px-4 md:px-8 z-10">
            <motion.div
              className="max-w-3xl"
              initial="hidden"
              animate="visible"
              ...
              variants={textVariants}
            >
              <h1 className="text-4xl md:text-6xl font-bold leading-snug mb-6 lg:whitespace-nowrap">
        ...
        <div className="relative w-full h-screen">
          ...
          <div className="absolute inset-0 bg-green-400 lg:bg-transparent md:bg-transparent ">
            <motion.div
              className="absolute inset-0 flex items-start lg:items-center justify-center lg:justify-start text-center lg:text-start px-4 md:p-8 z-10"
              initial="hidden"
              animate="visible"
              transition={{ duration: 1, delay: 0.3 }}
              variants={textVariants}
            >
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-6xl font-bold text-white leading-snug mb-6">
